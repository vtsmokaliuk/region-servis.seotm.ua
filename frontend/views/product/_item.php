        ...
        <div class="products">
            <div class="product">
                <div class="product-image">
                    <div class="image">
                        <a href="<?php echo $model->getAlias($model)?>">
                            <img src="<?php echo $model->getBigImage($model->id);?>" alt="">
                            <img src="<?php echo $model->getBigImage($model->id);?>" alt="" class="hover-image">
                        </a>
                    </div>
                    <!-- /.image -->
                ...
                <div class="product-info text-left">
                    ...
                    <div class="product-price"> <span class="price"> <?php echo $model->getProductPrice($model)?> </span> <span class="price-before-discount">$ 800</span> </div>
                    <!-- /.product-price -->
