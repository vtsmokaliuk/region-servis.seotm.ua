...
function MenuEditor(idSelector, options) {
    var $main = $("#" + idSelector);
    var settings = {
        labelEdit: '<i class="mdi mdi-lead-pencil"></i>',
        labelRemove: '<i class="mdi mdi-delete"></i>',
        ...
        listOptions: { hintCss: {border: '1px dashed #13981D'}, opener: {
                        as: 'html',
                        close: '<i class="mdi mdi-plus"></i>',
                        open: '<i class="mdi mdi-minus"></i>',
    ...
    function TButtonGroup() {
        ...
        var $btnUp = TButton({classCss: 'btn btn-default btn-xs btnUp btnMove', text: '<i class="mdi mdi mdi-arrow-up clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-default btn-xs btnDown btnMove', text: '<i class="mdi mdi mdi-arrow-down clickable"></i>'});
        var $btnOut = TButton({classCss: 'btn btn-default btn-xs btnOut btnMove', text: '<i class="mdi mdi-arrow-left clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-default btn-xs btnIn btnMove', text: '<i class="mdi mdi-arrow-right clickable"></i>'});
